...
> Note: this project is based on a well-known Databricks retail tutorial dataset (product names are placeholder brand names). I wrote the underlying SQL queries myself to build out the aggregations and visuals shown below.
